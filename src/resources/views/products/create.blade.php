...
<form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data" class="mx-auto" style="max-width: 600px;">
    ...
    {{-- 商品名 --}}
    <div class="mb-3">
        <label for="name" class="form-label">商品名 <span class="require">※必須</span></label>
    ...
    {{-- 商品値段 --}}
    <div class="mb-3">
        <label for="price" class="form-label">値段 <span class="require">※必須</span></label>
    ...
    {{-- 画像 --}}
    <div class="mb-3">
        <label for="image" class="form-label">商品画像 <span class="require">※必須</span></label>
    ...
    {{-- 季節カテゴリ --}}
    <div class="mb-3">
        <label class="form-label d-block">季節 <span class="require">※必須 複数選択</span></label>
